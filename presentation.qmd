...
* **Bruit sémantique** : fautes d'orthographes, infos personnelles, typos, ... 
...
* **Adaptée pour les LLM** : on fourni des éléments de la notice en contexte.
:::
...
* **Diversité de la génération** : utilisations de scores d'embeddings (DCScore, IMMD, ...), ou des rapprochements sémantiques (Jaccard Similarity, Self-BLEU, ...) ;
...
:::{.incremental}
* Idée de mimer la distribution sémantique originale ;
* Grand enjeu de stabilité au cours des itérations ;
* Passer à un paradigme tourné **RLHF si innefficace**.
:::

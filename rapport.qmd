...
Parailleurs, la construction d'un classifieur robuste se heurte à plusieurs difficultés majeures. En premier lieu, les données d'entraînement souffrent fréquemment d'un défaut de couverture : certains codes sont peu ou pas représentés, ce qui crée des zones d'ombre pour le modèle. Par exemple, pour la NAF 2025 (deuxième version de la nomenclature), sur 800 000 libellés d'entraînement, la moitié des 747 codes comprend moins de 50 occurences. À cela s'ajoute le risque lié à l'actualisation possible de la nomenclature, avec un potentiel décalage entre la distribution d'entraînement et de production.
